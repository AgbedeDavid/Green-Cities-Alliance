...
The project aimed to improve stakeholder engagement, support sustainable purchasing decisions, and provide data-driven insights that could influence environmental initiatives within local communities.

This repository showcases the Business Analysis activities, artefacts, techniques, and deliverables produced throughout the project lifecycle.
...
-Establish clear business rules and constraints.

-Model end-to-end business processes.

-Ensure traceability throughout the Software Development Lifecycle (SDLC).

-Validate that the delivered solution aligned with stakeholder expectations.
